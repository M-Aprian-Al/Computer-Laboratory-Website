					...
					<div class="col-md-4">
						...
						<table>
							<tr>
								<td width="40%">Nama</td>
								<td width="10%">:</td>
								<td width="50%">Aprian Almuharom</td>
							</tr>
							<tr>
								<td width="40%">Email</td>
								<td width="10%">:</td>
								<td width="50%">aprianian04@gmail.com</td>
							</tr>
							<tr>
								<td width="40%">HP</td>
								<td width="10%">:</td>
								<td width="50%">+6285780316852</td>
							</tr>
						</table>
					</div>
					<div class="col-md-2">
	...
	<section id="bottom-footer">
		<div class="container">
			<div class="content">
				<div class="row">
					<div class="col-md-12">
						<span class="copyright">&copy; 2015 All Rights Reserved | Aprian Almuharom</span>
