			...
			<div class="content cover text-center">
				<div class="row">
					<div class="col-lg-2" style="padding-top: 30px;">
						<img src="assets/img/Logo SMK.png" alt="" height="200">
					</div>
					<div class="col-lg-8" style="padding-top: 30px;">
						<label style="font-size:35px;">SISTEM INFORMASI LABORATORIUM TKJ</label><br>
						<h3><label>SMKN 1 Pebayuran</label></h3>
					</div>
					<div class="col-lg-2" style="padding-top: 30px;">
						<img src="assets/img/Logo TKJ.png" alt="" height="200">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="content text-center">
				<div class="heading">
					...
					<p>We are teacher on Laboratorium SMKN 1 Pebayuran.</p>
				</div>
				<div class="row">
					<?php 
